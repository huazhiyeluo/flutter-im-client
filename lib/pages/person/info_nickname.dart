...
class PersonInfoNickname extends StatefulWidget {
  const PersonInfoNickname({super.key});

  @override
  State<PersonInfoNickname> createState() => _PersonInfoNicknameState();
}

class _PersonInfoNicknameState extends State<PersonInfoNickname> {
