...
Future<void> initialDb(int uid) async {
  ...
  List<String> tableSQLs = [
    ...
    'CREATE TABLE IF NOT EXISTS `message` (id TEXT, fromId INTEGER, toId INTEGER, nickname TEXT,avatar TEXT, msgType INTEGER, msgMedia INTEGER, content TEXT,  createTime INTEGER)',
    ...
    'CREATE TABLE IF NOT EXISTS `share` (id INTEGER PRIMARY KEY,objId INTEGER,type INTEGER, name TEXT, info TEXT,remark TEXT, icon TEXT, operateTime INTEGER)',
  ];
